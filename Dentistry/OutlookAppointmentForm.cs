    ...
    public partial class OutlookAppointmentForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        ...
        private void Save(bool closeAfterSave)
        {
            ...
            if (closeAfterSave)
            {
                ...
                ds =  Convert.ToDateTime( edtStartDate.Text + " " + edtStartTime.Text);
                de = Convert.ToDateTime(edtEndDate.Text + " " + edtEndTime.Text);

                


                database_.ExeScalar("INSERT INTO [dbo].[Appointments]([Type],[StartDate],[EndDate],[AllDay],[Subject],[Location],[Description],[Status],[Label],[ResourceID],[ResourceIDs],[ReminderInfo],[RecurrenceInfo],[TimeZoneId],[CustomField1]) values (" + 0 + ",'"+ ds +"','"+ de +"'," + s + ",N'" + tbSubject.Text + "',N'" + tbLocation.Text + "',N'" + tbDescription.Text + "',1,1,1,'1','1','1','1','1') ");
        ...
        protected internal virtual void OnTimeZonesButton()
        {
            ...
            this.btnTimeZones.DataBindings["Down"].ReadValue();
        }
        ...
        private void barLabel_ItemClick(object sender, ItemClickEventArgs e)
        {
